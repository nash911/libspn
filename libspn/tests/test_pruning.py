...
class TestPruning(TestCase):
    ...
    def test_pruning_noivs(self):
        ...
        def full_network():
            ...
            """
            inp_var = spn.IVs(num_vars=4, num_vals=4, name="Input")

            # Layer - 1
            # Decomposition - 1
            s_11 = spn.Sum((inp_var, 0), (inp_var, 1), (inp_var, 2), (inp_var, 3),
                           name="S_1.1")
            s_11.generate_weights([0.3, 0.1, 0.3, 0.3])
            s_12 = spn.Sum((inp_var, 0), (inp_var, 1), (inp_var, 2), (inp_var, 3),
                           name="S_1.2")
            s_12.generate_weights([0.1, 0.4, 0.1, 0.4])

            s_21 = spn.Sum((inp_var, 4), (inp_var, 5), (inp_var, 6), (inp_var, 7),
                           name="S_2.1")
            s_21.generate_weights([0.25, 0.25, 0.25, 0.25])
            s_22 = spn.Sum((inp_var, 4), (inp_var, 5), (inp_var, 6), (inp_var, 7),
                           name="S_2.2")
            s_22.generate_weights([0.1, 0.2, 0.3, 0.4])

            # Decomposition - 2
            s_31 = spn.Sum((inp_var, 8), (inp_var, 9), (inp_var, 10), (inp_var, 11),
                           name="S_3.1")
            s_31.generate_weights([0.2, 0.2, 0.4, 0.2])
            s_32 = spn.Sum((inp_var, 8), (inp_var, 9), (inp_var, 10), (inp_var, 11),
                           name="S_3.2")
            s_32.generate_weights([0.25, 0.25, 0.25, 0.25])

            s_41 = spn.Sum((inp_var, 12), (inp_var, 13), (inp_var, 14), (inp_var, 15),
                           name="S_4.1")
            s_41.generate_weights([0.27, 0.28, 0.29, 0.16])
            s_42 = spn.Sum((inp_var, 12), (inp_var, 13), (inp_var, 14), (inp_var, 15),
                           name="S_4.2")
        ...
        def hand_pruned_network():
            ...
            # Layer - 1
            # Decomposition - 1
            s_11 = spn.Sum((inp_var, 0), (inp_var, 2), (inp_var, 3), name="S_1.1")
            s_11.generate_weights([0.3, 0.3, 0.3])
            s_12 = spn.Sum((inp_var, 1), (inp_var, 3), name="S_1.2")
            s_12.generate_weights([0.4, 0.4])

            s_22 = spn.Sum((inp_var, 6), (inp_var, 7), name="S_2.2")
            s_22.generate_weights([0.3, 0.4])

            # Decomposition - 2
            s_31 = spn.Sum((inp_var, 10), name="S_3.1")
            s_31.generate_weights([0.4])

            s_41 = spn.Sum((inp_var, 12), (inp_var, 13), (inp_var, 14), name="S_4.1")
            s_41.generate_weights([0.27, 0.28, 0.29])
            s_42 = spn.Sum((inp_var, 13), (inp_var, 15), name="S_4.2")
        ...
        root_full_network, inp_full_network = full_network()
        ...
        with spn.session() as (sess, run):
            ...
            full_network_value_out, full_network_log_value_out = \
                sess.run([value_full_network, log_value_full_network],
                         feed_dict={inp_full_network: feed})
    ...
    def test_pruning_ivs(self):
        ...
        def full_network():
            ...
            ivs_2 = spn.IVs(num_vars=2, num_vals=4, name="IVs_2")

            # Layer - 1
            # Decomposition - 1
            s_11 = spn.Sum((inp_var, 0), (inp_var, 1), (inp_var, 2), (inp_var, 3), name="S_1.1")
            s_11.generate_weights([0.3, 0.1, 0.3, 0.3])
            s_11.set_ivs((ivs_1, [0, 1, 2, 3]))
            s_12 = spn.Sum((inp_var, 0), (inp_var, 1), (inp_var, 2), (inp_var, 3), name="S_1.2")
            s_12.generate_weights([0.1, 0.4, 0.1, 0.4])
            s_12.set_ivs(ivs_1)

            s_21 = spn.Sum((inp_var, 4), (inp_var, 5), (inp_var, 6), (inp_var, 7), name="S_2.1")
            s_21.generate_weights([0.25, 0.25, 0.25, 0.25])
            s_22 = spn.Sum((inp_var, 4), (inp_var, 5), (inp_var, 6), (inp_var, 7), name="S_2.2")
            s_22.generate_weights([0.1, 0.2, 0.3, 0.4])

            # Decomposition - 2
            s_31 = spn.Sum((inp_var, 8), (inp_var, 9), (inp_var, 10), (inp_var, 11), name="S_3.1")
            s_31.generate_weights([0.2, 0.2, 0.4, 0.2])
            s_31.set_ivs((ivs_2, [0, 1, 2, 3]))
            s_32 = spn.Sum((inp_var, 8), (inp_var, 9), (inp_var, 10), (inp_var, 11), name="S_3.2")
            s_32.generate_weights([0.25, 0.25, 0.25, 0.25])
            s_32.set_ivs((ivs_2, [0, 1, 2, 3]))

            s_41 = spn.Sum((inp_var, 12), (inp_var, 13), (inp_var, 14), (inp_var, 15), name="S_4.1")
            s_41.generate_weights([0.27, 0.28, 0.29, 0.16])
            s_41.set_ivs((ivs_2, [4, 5, 6, 7]))
            s_42 = spn.Sum((inp_var, 12), (inp_var, 13), (inp_var, 14), (inp_var, 15), name="S_4.2")
            s_42.generate_weights([0.1, 0.35, 0.1, 0.45])
            s_42.set_ivs((ivs_2, [4, 5, 6, 7]))
            ...
            return inp_var, ivs_1, ivs_2, ivs_root, root
        ...
        def hand_pruned_network():
            ...
            s_31 = spn.Sum((inp_var, 10), name="S_3.1")
            s_31.generate_weights([0.4])
            s_31.set_ivs((ivs_2, 2))

            s_41 = spn.Sum((inp_var, 12), (inp_var, 13), (inp_var, 14), name="S_4.1")
            s_41.generate_weights([0.27, 0.28, 0.29])
            s_41.set_ivs((ivs_2, [4, 5, 6]))
            s_42 = spn.Sum((inp_var, 13), (inp_var, 15), name="S_4.2")
            s_42.generate_weights([0.35, 0.45])
            s_42.set_ivs((ivs_2, [5, 7]))
            ...
            root = spn.Sum(*[p_35], name="root")
            root.generate_weights([0.27])
            return inp_var, ivs_1, ivs_2, root

        # Build 2 custom SPNs: (1) A network to be pruned [Full-network]
        #                      (2) A network representing post-pruning [Hand-pruned]
        inp_full_network, ivs_1_full_network, ivs_2_full_network, \
            ivs_root_full_network, root_full_network = full_network()
        inp_hand_pruned_network, ivs_1_hand_pruned_network, \
            ivs_2_hand_pruned_network, root_hand_pruned_network = \
            hand_pruned_network()
        ...
        values = np.arange(-1, 4)
        points = np.array(np.meshgrid(*[values for i in range(4)])).T
        inp_feed = points.reshape(-1, points.shape[-1])

        # IVs feed
        ivs_1_feed = np.ones((inp_feed.shape[0], 1)) * -1
        ivs_2_feed = np.ones((inp_feed.shape[0], 2)) * -1
        ivs_root_feed = np.ones((inp_feed.shape[0], 1)) * -1
        ...
        with spn.session() as (sess, run):
            ...
            full_network_value_out, full_network_log_value_out = \
                sess.run([value_full_network, log_value_full_network],
                         feed_dict={inp_full_network: inp_feed,
                                    ivs_1_full_network: ivs_1_feed,
                                    ivs_2_full_network: ivs_2_feed,
                                    ivs_root_full_network: ivs_root_feed})
            hand_pruned_network_value_out = \
                sess.run(value_hand_pruned_network,
                         feed_dict={inp_hand_pruned_network: inp_feed,
                                    ivs_1_hand_pruned_network: ivs_1_feed,
                                    ivs_2_hand_pruned_network: ivs_2_feed})
