...
class PermProducts(OpNode):
    ...
    def __init__(self, *values, name="PermProducts"):
        ...
        if self._num_inputs == 1:
            ...
            self._num_prods = int(np.prod(value_sizes))
        ...
        # input values.
        self._permuted_indices = self.permute_indices(list(value_sizes))
    ...
    def _compute_mpe_path(self, counts, *value_values, add_random=False, use_unweighted=False):
        ...
        # TODO: Currently does not support varying input sizes.
